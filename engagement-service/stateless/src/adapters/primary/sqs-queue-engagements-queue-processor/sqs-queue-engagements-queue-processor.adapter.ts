...
import { queueProcessorUseCase } from '@use-cases/sqs-queue-engagements-queue-processor';
...
export const queueProcessorAdapter = async ({
  ...
  try {
    ...
    metrics.addMetric('SqsQueueEngagementsRecordProcessorError', MetricUnit.Count, 1);
